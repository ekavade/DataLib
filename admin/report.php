          ...
          <div class="row">
            <div class="col-sm-2" style="background-color:yellow;">
                ...
                <ul class="nav nav-pills">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active" href="report.php">Show Monthly Report</a>
                  </li>
                  <li class="nav-item">
            ...
            <div class="col-sm-10" style="background-color:orange;">
              <p>Here is Dashboard.</p>
                ...
                <div class="title">View List of the Books Booked in the month.</div>
                    <div class="container row">
                        <ul>
                            <li>
                        <hr>
                        List item 1, Student, bookname, date.
                            </li>
                        <li>
                            <hr>
                        List item 2
